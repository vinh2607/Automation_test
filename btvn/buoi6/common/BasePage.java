package nganttt.btvn.buoi6.common;
...
public class BasePage {
    ...
    protected void waitUntilVisibleElement(String xPath) {
    ...
    public List<Product> getListProduct() {
        ...
        elementPrice.forEach(element -> listPrice.add(Float.valueOf(element.getText().replace("$", ""))));

        for (int i = 0; i < elementName.size(); i++) {
            listProduct.add(new Product(listName.get(i), listPrice.get(i)));
        }
